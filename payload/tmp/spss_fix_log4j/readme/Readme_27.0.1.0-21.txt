...
4. How to apply the hot fix: 
	Win64 & UNIX
		...
		(2) Navigate to the Statistics 27.0.1.0 installation directory (e.g. $SPSS_HOME or 'C:\Program Files\IBM\SPSS\Statistics\27').
	...
	MacOS
		(1) Close the Statistics 27.0.1.0 application. 
		(2) Navigate to the Statistics 27.0.1.0 installation directory (e.g. $SPSS_HOME or '/Applications/IBM SPSS Statistics 27/').
		(3) Locate the following files and remove them to a backup location outside of the Statistics install path:
