...
#5282 Upgrade Log4j to 2.16.0 because high security risk 
...
4. How to apply the hot fix: 
	Win64 & UNIX
		...
		(2) Navigate to the Statistics 28.0.1.0 installation directory (e.g. $SPSS_HOME or 'C:\Program Files\IBM\SPSS Statistics\').
		(3) Locate the following files and remove them to a backup location outside of the Statistics install path:
			...
			$SPSS_HOME/as-3.3.0.0/lib/log4j-1.2-api-2.13.3.jar
			$SPSS_HOME/as-3.3.0.0/lib/log4j-core-2.13.3.jar
			$SPSS_HOME/as-3.3.0.0/lib/log4j-api-2.13.3.jar
		(4) Copy the interim fix files (log4j-core-2.16.0.jar, log4j-api-2.16.0.jar, log4j-1.2-api-2.16.0.jar) to these locations:
			$SPSS_HOME/
			$SPSS_HOME/as-3.3.0.0/lib/

	MacOS
		(1) Close the Statistics 28.0.1.0 application. 
		(2) Navigate to the Statistics 28.0.1.0 installation directory (e.g. $SPSS_HOME or '/Applications/IBM SPSS Statistics/').
		(3) Locate the following files and remove them to a backup location outside of the Statistics install path:
